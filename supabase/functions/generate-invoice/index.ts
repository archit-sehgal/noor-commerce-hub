...
// Invoice number is now auto-generated by database trigger (generate_invoice_number)
// Format: NC-YYYY-XXXX (e.g., NC-2026-3137)
    ...
    if (existingInvoice) {
      ...
      const { data: newInvoice, error: invoiceError } = await supabase
        ...
        .insert({
          ...
          invoice_number: 'TEMP', // Will be replaced by database trigger
